...
// 20240422: convert one input png/bmp to gray8bit16 bmp. mainly for
// standby/poweroff logo display by android(HWC).
int main(int argc, char *argv[])
{
    ...
    fprintf(stderr, "ver20240422: arguments : %d. use for ht-gray8bit16 logo.\n", argc - 1);
