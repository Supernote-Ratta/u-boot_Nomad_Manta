...
#define ANDROID_ARG_PRODUCTCOUNTRYCODE                  "androidboot.productcountrycode="
#define ANDROID_ARG_PRODUCTLANGUAGE                     "androidboot.productlanguage="
#define ANDROID_ARG_PRODUCTREGION                       "androidboot.productregion="
#define ANDROID_ARG_PRODUCTWIFIMAC                      "androidboot.productwifimac="
#define ANDROID_ARG_PRODUCTBTMAC                        "androidboot.productbtmac="
/* changed end. */
